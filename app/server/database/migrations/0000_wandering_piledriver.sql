...
CREATE TYPE "public"."task_assignment_status" AS ENUM('OPEN', 'PARTLY_ASSIGNED', 'FULLY_ASSIGNED');--> statement-breakpoint
...
CREATE TABLE "task_assignments" (
	...
	CONSTRAINT "task_assignments_user_id_task_id_pk" PRIMARY KEY("user_id","task_id")
);
--> statement-breakpoint
...
CREATE TABLE "tasks" (
	...
	"assignmentStatus" "task_assignment_status" DEFAULT 'OPEN' NOT NULL,
	"title" text NOT NULL,
	"description" text,
	...
	"expense" integer,
	"factor" numeric(2),
	"max_assignment_count" integer DEFAULT 1 NOT NULL
);
--> statement-breakpoint
CREATE TABLE "users" (
